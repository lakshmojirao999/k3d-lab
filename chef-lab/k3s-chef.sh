for node in k3schef k3snode1 k3snode2;do
  multipass launch -n $node
done
# Init cluster on node1
multipass exec k3schef -- bash -c "dpkg -i chef-workstation_21.10.640-1_amd64.deb"

# Get node1's IP
IP=$(multipass info k3chef | grep IPv4 | awk '{print $2}')
